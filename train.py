...
def train(model, annotation_path, input_shape, anchors, num_classes, log_dir='logs/'):
    ...
    model.fit_generator(data_generator_wrap(lines[:num_train], batch_size, input_shape, anchors, num_classes),
                        ...
                        epochs=200,
                        initial_epoch=0)
    model.save_weights(log_dir + 'trained_tiny_weights.h5')
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=0,
                      weights_path='./logs/000/trained_tiny_weights.h5'):
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=True,
                 weights_path='./logs/000/trained_weights.h5'):
    K.clear_session()  # get a new session
    image_input = Input(shape=(None, None, 3))
    h, w = input_shape
    num_anchors = len(anchors)
